...
use aptos_types::{
    ...
    state_store::{
        errors::AptosDbError, in_memory_state_view::InMemoryStateView, state_key::StateKey,
...
impl TStateView for FakeDataStore {
    ...
    fn get_state_value(&self, state_key: &StateKey) -> Result<Option<StateValue>, AptosDbError> {
